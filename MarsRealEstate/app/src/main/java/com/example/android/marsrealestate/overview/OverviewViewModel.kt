...
class OverviewViewModel : ViewModel() {
    ...
    fun displayPropertiesDetails(marsProperty: MarsProperty) {
        Log.i("test_click", "## ${this.javaClass.simpleName} ## -- displayPropertiesDetails "
                + marsProperty.id)
        _navigateToSelectedProperty.value = marsProperty
    }

    /**
     *we need to clear the LiveData to avoid it being triggered again when we return from
     * the DetailView, we'll add a this method that nulls out the value of
     * the navigateToSelectProperty LiveData.
     */
    fun displayPropertiesDetailsCompelet() {
    ...
    private fun getMarsRealEstateProperties(filter: MarsApiFilter) {
        ...
        viewModelScope.launch {
            ...
            try {
                _properties.value = MarsApi.retrofitService.getProperties(filter.filter)
